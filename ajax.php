...
function getSociales(){
	...
	//$params  = array('q' =>'@'.HASHTAG.$exclude); //por hashtag
	$params  = array('from' => HASHTAG); //por usuario
	...
	/*instagram*/
	//$json   = file_get_contents_curl('https://api.instagram.com/v1/tags/'.HASHTAG.'/media/recent?client_id='.CLIENT_ID);	    //por hashtag
	$json   = file_get_contents_curl('https://api.instagram.com/v1/users/'.IDUSERINST.'/media/recent/?client_id='.CLIENT_ID);	//por usuario	
